...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background">
      {mockSource !== 'serpapi' ? (
        <div className="fixed inset-x-0 top-0 z-[60] bg-amber-500 px-4 py-2 text-center text-xs font-bold text-amber-950">
          🧪 Mock Mode, Flights &amp; hotels generated by {mockSource === 'groq' ? 'Groq' : 'DeepSeek'}. Transport &amp; places still use Gemini.
        </div>
      ) : null}
      <DataSourcePanel />
      {/* Hero */}
